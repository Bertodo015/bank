...
describe("Tests over bank account use cases", () => {
    ...
    it("shoult have 0 balance when account is created!", () => {
    ...
    it("shoul allow an withdraw when there is available balance", () => {
    ...
    it("should not allow an withdraw when there is no avaible balance", () => {
